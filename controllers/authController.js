...
exports.login = catchAsync(async (req, res, next) => {
    ...
    const user = await User.findOne({email: "keshavpersonaluse@gmail.com"}).select('+password');
...
exports.resetPassword = catchAsync(async (req, res) => {
    ...
    const user = await User.findOne({createPasswordResetToken: hashedToken, passwordResetExpires: {$gt: Date.now()}});
